...
syntax match taskWorkingItem "^-.*" contains=taskWorkingIcon,markdownLinkText,markdownItalic,markdownBold,markdownCode
syntax match taskWorkingItem "^\s*-.*" contains=taskWorkingIcon,markdownLinkText,markdownItalic,markdownBold,markdownCode
syntax match taskDoneItem "^✓.*" contains=taskDoneIcon
syntax match taskDoneItem "^\s*✓.*" contains=taskDoneIcon
